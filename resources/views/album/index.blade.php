                        ...
                        <tr>
							...
							<td class="table-text">
                                <div>
									...
									<a href='{{ asset("uploads/albums/large/$album->album_cover")}}' data-lightbox="{{$album->album_name}}">
										<img src='{{ asset("uploads/albums/thumb/$album->album_cover")}}' />
									</a>
								</div>
                            </td>
							<td class="table-text">
                            ...
                            <td>
							  ...
							  <a href="{{ route('album.download', base64_encode($album->id)) }}" class="label label-info">Download</a>								
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
